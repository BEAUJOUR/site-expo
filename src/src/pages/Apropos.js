  ...
  return (
    <main className="apropos">
      ...
      <section className="container section animate-on-scroll">
        ...
        <ul>
          <li>✔️ Plans 3D à partir de vos idées</li>
          <li>✔️ Fabrication sur mesure</li>
          <li>✔️ Livraison</li>
          <li>✔️ Pose professionnelle</li>
        </ul>
      </section>
      ...
      <section className="container section animate-on-scroll">
        <h2>Nos valeurs</h2>
        <ul>
          <li><strong>✔️ Qualité :</strong> Des finitions soignées et des matériaux haut de gamme</li>
          <li><strong>✔️ Innovation :</strong> L’alliance du savoir-faire traditionnel et des outils numériques</li>
          <li><strong>✔️ Écoute :</strong> Un accompagnement personnalisé</li>
          <li><strong>✔️ Écoresponsabilité :</strong> Circuits courts et matériaux certifiés</li>
        </ul>
      </section>
