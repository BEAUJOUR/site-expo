...
const Services = () => {
  ...
  // Réinitialiser refs à chaque rendu
  sectionsRef.current = [];
  ...
  return (
    <div className="services-page">
      {/* HERO */}
      <header className="services-hero" data-aos="zoom-out" style={{ backgroundImage: `url(${menuiserie})` }}>
      ...
      {/* Présentation */}
      <section className="presentation container hidden fade-in-up" ref={el => el && sectionsRef.current.push(el)}>
        <h2 className="hidden fade-in-left" ref={el => el && sectionsRef.current.push(el)}>Présentation</h2>
        <p className="hidden zoom-in" ref={el => el && sectionsRef.current.push(el)}>
        ...
        <p className="hidden fade-in-left" ref={el => el && sectionsRef.current.push(el)}>
        ...
        <ul className="hidden zoom-in" ref={el => el && sectionsRef.current.push(el)}>
          <li className="hidden fade-in-up" ref={el => el && sectionsRef.current.push(el)}>Plans 3D personnalisés</li>
          <li className="hidden fade-in-up" ref={el => el && sectionsRef.current.push(el)}>Fabrication dans nos ateliers</li>
          <li className="hidden fade-in-up" ref={el => el && sectionsRef.current.push(el)}>Livraison & pose</li>
        </ul>
      </section>

      {/* Services list */}
      <section className="services-list container" ref={el => el && sectionsRef.current.push(el)}>
        {services.map((service, index) => (
          ...
          >
            ...
            <div className="service-info">
              <h2 className="hidden fade-in-left" ref={el => el && sectionsRef.current.push(el)}>{service.title}</h2>
              <p className="hidden fade-in-up" ref={el => el && sectionsRef.current.push(el)}>{service.description}</p>
            </div>
          </div>
        ))}
      </section>
      ...
      {/* Stand */}
      <section className="stand container hidden fade-in-right" ref={el => el && sectionsRef.current.push(el)}>
        <h2 className="hidden fade-in-left" ref={el => el && sectionsRef.current.push(el)}>Stands & Expositions</h2>
        <p className="hidden fade-in-up" ref={el => el && sectionsRef.current.push(el)}>
        ...
        <p className="hidden fade-in-right" ref={el => el && sectionsRef.current.push(el)}>
      ...
      {/* Agencement */}
      <section className="agencement container hidden fade-in-left" ref={el => el && sectionsRef.current.push(el)}>
        <h2 className="hidden zoom-in" ref={el => el && sectionsRef.current.push(el)}>Agencement</h2>
        <p className="hidden fade-in-up" ref={el => el && sectionsRef.current.push(el)}>
