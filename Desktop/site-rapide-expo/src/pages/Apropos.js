    ...
    <main className="apropos">
      ...
      <header className="apropos-hero animate-on-scroll fade-in-up">
        <div className="overlay">
          <h1 className="animate-on-scroll fade-in-down">Notre passion au service de vos espaces</h1>
        </div>
      </header>
      ...
      <section className="apropos-gallery container section animate-on-scroll fade-in-up">
        <h2 className="animate-on-scroll flipIn">Notre savoir-faire en images</h2>
        <div className="gallery">
          {images.map((img, index) => (
            <img key={index} src={img.src} alt={img.alt} loading="lazy" className="animate-on-scroll blurIn" />
          ))}
        </div>
      </section>
      ...
      {/* FAQ */}
      <section className="container section animate-on-scroll fade-in-right">
        <h2 className="animate-on-scroll growIn">Besoin d’aide ? Consultez notre FAQ</h2>
        <div className="faq">
